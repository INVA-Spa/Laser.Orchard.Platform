...
namespace Laser.Orchard.CulturePicker.Services {
    ...
    public class ContentLocalizableRouteService2 : ILocalizableRouteService2 {
        private readonly ILocalizableContentService _localizableContentService;

        public ContentLocalizableRouteService2(ILocalizableContentService localizableContentService,
                                              IOrchardServices services) {
            _localizableContentService = localizableContentService;
            Services = services;
        ...
        public bool TryFindLocalizedUrl(LocalizableRouteContext localizableRouteContext, string url) {
            bool translatedUrlFound = false;
